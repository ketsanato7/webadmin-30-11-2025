...
registration_place_issue: z.string().min(1, { message: "Required id" }),

tax_no: z.string().min(1, { message: "Required id" }),
regulatory_capital: z.string().min(1, { message: "Required id" }),
currency_id: z.string().min(1, { message: "Required id" }),
